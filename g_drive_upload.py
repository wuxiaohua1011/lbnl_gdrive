...
def parse_args():
    ...
    parser.add_argument('-d', '--destination', type=str,
                        help='Destination Folder name in Google Drive')
    parser.add_argument('-p', '--parent_id', type=str,
                        help='Parent Folder id in Google Drive')
...
def upload_files_in_folder(drive, folder_id, src_folder_name):
    ...
    for object_name in os.listdir(src_folder_name):
        ...
        # Skip the file if it's empty
            ...
            print('file {0} is empty'.format(filepath))
...
def main():
    ...
    src_folder_name = "~/Desktop/projects/lbnl/g_drive/test_upload"
    dst_folder_name = "test_upload"
    parent_folder_id = "1kKqZQh5v6YiW1lE8bS2q7ZrE0isHFYqu"
    print(f"Running with parameters: source = {src_folder_name}, "
          f"destination = {dst_folder_name},  parent_id = {parent_folder_id}")
